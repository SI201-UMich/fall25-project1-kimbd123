...
#uniqname: kimbd
#ID: 69330016
#AI: I did use Gen AI to help me decompose the calculations. I also used Gen AI to help me fix errors in my code.
...
def penguins_results(avg, maximum):
